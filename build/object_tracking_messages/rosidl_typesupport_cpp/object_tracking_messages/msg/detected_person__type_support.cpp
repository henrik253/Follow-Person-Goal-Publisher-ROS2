...
static const _DetectedPerson_type_support_symbol_names_t _DetectedPerson_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, object_tracking_messages, msg, DetectedPerson)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, object_tracking_messages, msg, DetectedPerson)),
  }
};
...
{
  return &::object_tracking_messages::msg::rosidl_typesupport_cpp::DetectedPerson_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, object_tracking_messages, msg, DetectedPerson)() {
  return get_message_type_support_handle<object_tracking_messages::msg::DetectedPerson>();
}
