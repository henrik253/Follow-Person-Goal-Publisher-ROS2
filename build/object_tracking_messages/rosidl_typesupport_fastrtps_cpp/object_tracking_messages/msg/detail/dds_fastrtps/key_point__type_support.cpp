...
#include "object_tracking_messages/msg/detail/key_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const object_tracking_messages::msg::KeyPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  object_tracking_messages::msg::KeyPoint & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = object_tracking_messages::msg::KeyPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const object_tracking_messages::msg::KeyPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<object_tracking_messages::msg::KeyPoint *>(
    untyped_ros_message);
...
{
  return &object_tracking_messages::msg::typesupport_fastrtps_cpp::_KeyPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, object_tracking_messages, msg, KeyPoint)() {
  return &object_tracking_messages::msg::typesupport_fastrtps_cpp::_KeyPoint__handle;
}
