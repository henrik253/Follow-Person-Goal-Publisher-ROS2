...
#include "object_tracking_messages/msg/detail/detected_persons__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const object_tracking_messages::msg::DetectedPerson &,
  ...
  size_t current_alignment)
{
  ...
  // Member: persons
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        object_tracking_messages::msg::typesupport_fastrtps_cpp::max_serialized_size_DetectedPerson(
  ...
  if (is_plain) {
    ...
    using DataType = object_tracking_messages::msg::DetectedPersons;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const object_tracking_messages::msg::DetectedPersons *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<object_tracking_messages::msg::DetectedPersons *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DetectedPersons__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const object_tracking_messages::msg::DetectedPersons *>(
...
static size_t _DetectedPersons__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DetectedPersons(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DetectedPersons__callbacks = {
...
static rosidl_message_type_support_t _DetectedPersons__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DetectedPersons__callbacks,
...
{
  return &object_tracking_messages::msg::typesupport_fastrtps_cpp::_DetectedPersons__handle;
}
