...
{
  new (message_memory) object_tracking_messages::msg::BoundingBox(_init);
}

void BoundingBox_fini_function(void * message_memory)
{
  auto typed_message = static_cast<object_tracking_messages::msg::BoundingBox *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBox_message_member_array[4] = {
  {
    ...
    offsetof(object_tracking_messages::msg::BoundingBox, x_min),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(object_tracking_messages::msg::BoundingBox, y_min),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(object_tracking_messages::msg::BoundingBox, x_max),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(object_tracking_messages::msg::BoundingBox, y_max),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundingBox_message_members = {
  ...
  4,  // number of fields
  sizeof(object_tracking_messages::msg::BoundingBox),
...
{
  return &::object_tracking_messages::msg::rosidl_typesupport_introspection_cpp::BoundingBox_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, object_tracking_messages, msg, BoundingBox)() {
  return &::object_tracking_messages::msg::rosidl_typesupport_introspection_cpp::BoundingBox_message_type_support_handle;
}
